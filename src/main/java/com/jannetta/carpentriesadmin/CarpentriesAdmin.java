...
import static com.jannetta.carpentriesadmin.dao.Retrieving.*;
    ...
    public static void main(String[] args) {
        ...
        while (option != 999) {
            System.out.print("1) Import People, " +
                    ...
                    "\n21) List All People, 22) List Workshops, 23) List Helpers, 24) List Instructors" +
                    "\n51) Drop Table, " +
            ...
            switch (option) {
                ...
                case 23:
                    System.out.print("List Workshops: ");
                    ArrayList<String> helpers = getPeople('h');
                    int c = 0;
                    helpers.forEach(s -> System.out.println(helpers.indexOf(s) + "\t" + s));
                    break;
                case 24:
                    System.out.print("List Workshops: ");
                    ArrayList<String> instructors = getPeople('i');
                    instructors.forEach(s -> System.out.println(instructors.indexOf(s) + "\t" + s));
                    break;
                case 51:
